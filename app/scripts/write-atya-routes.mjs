...
const publicWhitelist = [
  ...
  "assets/huang-xuelian-2026.jpg",
  "assets/lin-zehui-2026.jpg",
  "assets/lu-xiaoni-2026.jpg",
...
const featuredRoleItems = [
  {
    name: "王泽平",
    role: "青年会会长",
    image: "assets/wang-zeping-2026-transparent.png",
    description: "SOYO TOUR SERVICE PTY LTD；GEMINI PLUS PTY LTD；TEOSWA PTY LTD；THE NEW HOTPOT 醉牛火锅；揭阳市澳合投资有限公司；揭阳市侨联第五届委员会顾问；澳大利亚潮汕青年会会长；澳大利亚潮汕商会副会长；澳洲潮州同乡会青年会昆州分会会长；澳大利亚潮汕总会第一届副会长",
  },
  {
    name: "王罗湳",
    role: "青年会执行会长",
    image: "assets/roland-2026-transparent.png",
    description: "Stanley Team；WAYNE INSIGHTSPRING CONSULTING CO., LTD；MedFlowEdu；昆士兰大学医学学部全奖博士候选人；澳大利亚潮汕青年会执行会长；澳大利亚潮汕商会副会长",
  },
  {
    name: "辛卓阳",
    role: "青年会副会长",
    image: "assets/xin-zhuoyang-2026.jpg",
